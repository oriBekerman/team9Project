...
public class EmployeesRepository extends BaseRepository<Employee>{

    //    private final SessionFactory sessionFactory;
    public EmployeesRepository(SessionFactory sessionFactory) {
        super(sessionFactory);
    }

    @Override
    public int getId(Employee entity) {
        return ((Employee)entity).getEmployeeID();
    }
